...
public class TC_51_GB_PASOS_ADQ_700 {
		...
		try {
			...
			if (report.validateObjectIsDisplayable(repo.get_obj_lblRunIdRan(runId))) {
				...
				if (chkProcesado.equals("2/0")) {
					report.AddLine("Resultado Correcto. Se procesó 2 Registro OK y 0 Errores");
					System.out.println("Resultado Correcto. Se procesó 2 Registro OK y 0 Errores");
					Status[0] = "P";
				} else {
					report.AddLineAssertionError("Error - Se procesaron " + chkProcesado.split("/")[0] + " de 2 Registro y " + chkProcesado.split("/")[1] + " de 0 Errores");
					System.out.println("Error - Se procesaron " + chkProcesado.split("/")[0] + " de 2 Registro y " + chkProcesado.split("/")[1] + " de 0 Errores");
					Status[0] = "Fail - Se procesaron " + chkProcesado.split("/")[0] + " de 2 Registro y " + chkProcesado.split("/")[1] + " de 0 Errores";
				}
