...
public class TC_53_GB_PASOS_ADQ_700 {
	...
	public void pagina3(Reports report, Repo_WebRepository repo, DriverManager DM, String name) {
		...
		DateTimeFormatter yearSystemDTF = DateTimeFormatter.ofPattern("yyyMMdd");
		String sysDate = yearSystemDTF.format(LocalDateTime.now());
