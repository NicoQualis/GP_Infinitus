...
public class TC_82_GB_PASOS_ADQ_700 {
	...
	public void pagina3(Reports report, Repo_WebRepository repo, DriverManager DM, String name) {
		...
		repo.get_obj_inputById("parametro_01").sendKeys("20220803");

		report.AddLine("Se ingresa comercio");
		System.out.println("Se ingresa comercio");
