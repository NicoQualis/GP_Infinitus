...
public class TC_08_GB_PASOS_ADQ_701 {
	...
	public void pagina3(Reports report, Repo_WebRepository repo, DriverManager DM, String name) {
		...
		repo.get_obj_inputById("parametro_02").sendKeys("20220530");
		
		report.AddLine("Se ingresa identificador de terminal");
		System.out.println("Se ingresa identificador de terminal");
