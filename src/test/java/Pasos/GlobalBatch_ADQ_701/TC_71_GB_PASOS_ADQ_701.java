...
public class TC_71_GB_PASOS_ADQ_701 {
		...
		try {
			...
			if (report.validateObjectIsDisplayable(repo.get_obj_lblRunIdRan(runId))) {
				...
				if (chkProcesado.equals("1/0")) {
					...
					report.AddLineAssertionError("Error - Se procesaron " + chkProcesado.split("/")[0] + " de 1 Registros y " + chkProcesado.split("/")[1] + " de 0 Errores");
					System.out.println("Error - Se procesaron " + chkProcesado.split("/")[0] + " de 1 Registros y " + chkProcesado.split("/")[1] + " de 0 Errores");
