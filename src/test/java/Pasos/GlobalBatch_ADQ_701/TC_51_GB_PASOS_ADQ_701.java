...
public class TC_51_GB_PASOS_ADQ_701 {
		...
		try {
			...
			if (report.validateObjectIsDisplayable(repo.get_obj_lblRunIdRan(runId))) {
				...
				if (chkProcesado.equals("2/0")) {
					report.AddLine("Resultado Correcto. Se procesó 1 Registro OK y 0 Errores");
					System.out.println("Resultado Correcto. Se procesó 1 Registro OK y 0 Errores");
					Status[0] = "P";
				} else {
