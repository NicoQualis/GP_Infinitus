...
public class TC_05_GO_PASOS_ADQ_700 {
	WebDriver driver;
	...
	public void pagina2(Datasources data,Reports report, DriverManager DM, int iteration,String name,Repo_WebRepository repo, String sysDate) throws InterruptedException {
		...
		repo.get_obj_inputTextByName("inputFinanciacionDescripcion").sendKeys("Financiacion Automation");
		
		Thread.sleep(300);
		
		
		report.AddLine("Se carga Sistema de Financiaci�n");
		System.out.println("Se carga Sistema de Financiaci�n \r\n");
		repo.get_obj_selectOptionByName("selectFinanciacionSist", "FINANCIACION OTORGANTE").click();
