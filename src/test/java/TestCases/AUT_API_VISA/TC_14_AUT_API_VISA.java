...
public class TC_14_AUT_API_VISA{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/VISA/TC_68_Crédito_ReversoLocal_Contactless.txt";
...
//			token = AI.getToken(report, apiResp);
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		//Segunda Validación
		queryVerf = "select anular_reversar, COALESCE(id_auto_adq_anular_reversar, (-1)) "
