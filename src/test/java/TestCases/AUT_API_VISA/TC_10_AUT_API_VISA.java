...
public class TC_10_AUT_API_VISA{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/VISA/TC_63_Crédito_AnulaciónLocal_Ecommerce.txt";
			String pathPre = "./API_Requests/Autorizador/VISA/PRE_ECOMMERCE_VISA.txt";
...
//			token = AI.getToken(report, apiResp);
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[0].equals("2")) {
			...
			report.AddLine("Resultado Correcto. ID_ESTADO: " + respVerifBDD[0].toString());
			System.out.println("Resultado Correcto. ID_ESTADO: " + respVerifBDD[0] + "\r\n");
			Status[0] = "P";
		}

		//Validación del MODO_INGRESO - Tiene que ser igual a 81
		if (!respVerifBDD[1].equals("81")) {
			report.AddLine("MODO_INGRESO: " + respVerifBDD[1] + ". Se esperaba: 81");
			System.out.println("MODO_INGRESO: " + respVerifBDD[1] + ". Se esperaba: 81\r\n");
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del IN_MODO_INGRESO_TERMINAL - Tiene que ser: '0110'
		if (!respVerifBDD[1].equals("0110")) {
			report.AddLine("IN_MODO_INGRESO_TERMINAL: " + respVerifBDD[1] + ". Se esperaba: 0110");
			System.out.println("IN_MODO_INGRESO_TERMINAL: " + respVerifBDD[1] + ". Se esperaba: 0110\r\n");
		...
		//Validación del ID_TIPO_AUTORIZACION_ADQ_LOG - Tiene que ser: '6'
