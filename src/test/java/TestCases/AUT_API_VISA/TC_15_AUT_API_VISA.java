...
public class TC_15_AUT_API_VISA{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/VISA/TC_69_Crédito_ReversoLocal_Ecommerce.txt";
...
//			token = AI.getToken(report, apiResp);
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		//Segunda Validación
		queryVerf = "select anular_reversar, id_auto_adq_anular_reversar from autorizacion_adquirente_log where id_autorizacion_adquirente = " + rrnLast6;
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[1].equals("81")) {
			report.AddLineAssertionError("MODO_INGRESO: " + respVerifBDD[1] + ". Se esperaba: 81");
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[1].equals("0110")) {
			report.AddLineAssertionError("IN_MODO_INGRESO_TERMINAL: " + respVerifBDD[1] + ". Se esperaba: 0110");
		...
		//Validación del ID_TIPO_AUTORIZACION_ADQ_LOG - Tiene que ser: '9'
		if (!respVerifBDD[2].equals("9")) {
			report.AddLineAssertionError("ID_TIPO_AUTORIZACION_ADQ_LOG: " + respVerifBDD[2] + ". Se esperaba: 9");
