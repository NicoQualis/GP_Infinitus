...
public class TC_06_AUT_API_VISA{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/VISA/TC_59_Crédito_AnulaciónLocal_Manual.txt";
			String pathPre = "./API_Requests/Autorizador/VISA/PRE_MANUAL_VISA.txt";
	...
	private String[] execPreCondicion(Reports report, Repo_Variables repoVar, AutorizadorInterno AI, apiWorker apiResp, String bodyData, String path, String configEntidad) throws Exception {
		...
		if (RespcodeData.equals("00")) {
			...
			report.AddLineAssertionError("FAIL<br>responseCode: " + rta[0] + " Se esperaba: 00");
			System.out.println("##[warning] : FAIL : \r\nresponseCode: " + rta[0] + " Se esperaba: 00\r\n");
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		//Primera Validación
		queryVerf = "select id_estado, modo_ingreso, id_marca, id_autorizacion, id_autorizacion_adquirente from autorizacion where id_autorizacion_adquirente = " + rrnLast6;
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del ID_MARCA - Tiene que ser igual a 2
		if (!respVerifBDD[2].equals("2")) {
			report.AddLineAssertionError("ID_MARCA: " + respVerifBDD[2] + ". Se esperaba: 2");
			System.out.println("ID_MARCA: " + respVerifBDD[2] + ". Se esperaba: 2\r\n");
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[2].equals("6")) {
			report.AddLineAssertionError("ID_TIPO_AUTORIZACION_ADQ_LOG: " + respVerifBDD[2] + ". Se esperaba: 6");
		...
		if (!respVerifBDD[3].equals("0400")) {
			report.AddLineAssertionError("OUT_TIPO_MENSAJE: " + respVerifBDD[3] + ". Se esperaba: 0400");
		...
		if (!respVerifBDD[4].equals(id_Auto)) {
			report.AddLineAssertionError("ID_AUTORIZACION_ORIGINAL: " + respVerifBDD[4] + ". Se esperaba: " + id_Auto);
		...
		if (!respVerifBDD[5].equals(id_AutoAdq)) {
			report.AddLineAssertionError("ID_AUTO_ADQ_ORIGEN: " + respVerifBDD[5] + ". Se esperaba: " + id_AutoAdq);
