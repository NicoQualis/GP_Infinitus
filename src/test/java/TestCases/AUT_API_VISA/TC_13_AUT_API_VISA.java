...
public class TC_13_AUT_API_VISA{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/VISA/TC_67_Crédito_ReversoLocal_Chip.txt";
			String pathPre = "./API_Requests/Autorizador/VISA/PRE_CHIP_VISA.txt";
...
//			token = AI.getToken(report, apiResp);
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		queryVerf = "select id_estado, modo_ingreso, id_autorizacion, id_autorizacion_adquirente "
				+ "from autorizacion where id_autorizacion_adquirente = " + rrnLast6;
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[1].equals("05")) {
			report.AddLineAssertionError("MODO_INGRESO: " + respVerifBDD[1] + ". Se esperaba: 05");
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del IN_MODO_INGRESO_TERMINAL - Tiene que ser: '0510'
		if (!respVerifBDD[1].equals("0510")) {
			report.AddLineAssertionError("IN_MODO_INGRESO_TERMINAL: " + respVerifBDD[1] + ". Se esperaba: 0510");
			System.out.println("IN_MODO_INGRESO_TERMINAL: " + respVerifBDD[1] + ". Se esperaba: 0510\r\n");
		...
		//Validación del ID_AUTO_ADQ_ORIGEN - Tiene que ser: 'ID_AUTO'
