...
public class TC_03_AUT_API_VISA{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/VISA/TC_44_Credito_CompraLocal_Chip.txt";
			String token = "";
			String bodyData = "";
			String respBody = "";
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		queryVerf = "select count(*) from autorizacion a \r\n"
				...
				+ "where a.id_autorizacion_adquirente = '" + rrnLast6 + "' and a.modo_ingreso = '05' and a.id_marca = '2'";
