...
public class TC_08_AUT_API_VISA{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/VISA/TC_61_Crédito_AnulaciónLocal_Chip.txt";
...
//			token = AI.getToken(report, apiResp);
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//select  in_cod_procesamiento, id_tipo_autorizacion_adq_log, out_tipo_mensaje, id_autorizacion_original, id_auto_adq_origen
		...
		if (!respVerifBDD[1].equals("0510")) {
			report.AddLine("IN_MODO_INGRESO_TERMINAL: " + respVerifBDD[1] + ". Se esperaba: 0510");
