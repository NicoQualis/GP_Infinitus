...
public class TC_09_AUT_API_VISA{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/VISA/TC_62_Crédito_AnulaciónLocal_Contactless.txt";
			String pathPre = "./API_Requests/Autorizador/VISA/PRE_CONTACTLESS_VISA.txt";
			...
			//Stop-Start del simulador
			System.out.println("##### INICIO DE STOP/START DEL SIMULADOR #####");
			report.AddLine("##### INICIO DE STOP/START DEL SIMULADOR #####");
			...
			System.out.println("##### FIN DE STOP/START DEL SIMULADOR#####");
...
//			token = AI.getToken(report, apiResp);
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		//Segunda Validación
		queryVerf = "select anular_reversar, id_auto_adq_anular_reversar "
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del MODO_INGRESO - Tiene que ser igual a 07
		if (!respVerifBDD[1].equals("07")) {
			report.AddLineAssertionError("MODO_INGRESO: " + respVerifBDD[1] + ". Se esperaba: 07");
			System.out.println("MODO_INGRESO: " + respVerifBDD[1] + ". Se esperaba: 07\r\n");
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del IN_MODO_INGRESO_TERMINAL - Tiene que ser: '0710'
		if (!respVerifBDD[1].equals("0710")) {
			report.AddLineAssertionError("IN_MODO_INGRESO_TERMINAL: " + respVerifBDD[1] + ". Se esperaba: 0710");
			System.out.println("IN_MODO_INGRESO_TERMINAL: " + respVerifBDD[1] + ". Se esperaba: 0710\r\n");
