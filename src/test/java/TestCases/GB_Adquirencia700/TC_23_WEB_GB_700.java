...
import Pasos.GlobalBatch_ADQ_700.TC_23_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_23_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_23_GB_PASOS_ADQ_700 pasos = new TC_23_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_23_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta.equals("2022-06-16 00:00:00")) { 
			...
			report.AddLineAssertionError("El campo FECHA_CIERRE_COMERCIO tiene fecha de cierre de comercio: "+rta+", se esperaba el registro 2022-06-16 00:00:00");
			System.out.println("El campo FECHA_CIERRE_COMERCIO tiene fecha de cierre de comercio: "+rta+", se esperaba el registro 2022-06-16 00:00:00 \r\n");
