...
import Pasos.GlobalBatch_ADQ_700.TC_37_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_37_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_37_GB_PASOS_ADQ_700 pasos = new TC_37_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_37_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		queryVerif = "select c.id_mod_financ_comercio, c.importe_interes_com, c.porcentaje_financ, c.id_sistema_financiacion, c.tipo_porc_financ, c.importe_iva_interes_com "
				...
				+ "where a.id_autorizacion_adquirente in ('348419')";
		...
		if (rta[0].equals("18")) { 
			...
			report.AddLineAssertionError("El campo ID_MOD_FINANC_COMERCIO tiene el registro: "+rta[0]+", se esperaba el registro 18");
			System.out.println("El campo ID_MOD_FINANC_COMERCIO  tiene el registro: "+rta[0]+", se esperaba el registro 18 \r\n");
