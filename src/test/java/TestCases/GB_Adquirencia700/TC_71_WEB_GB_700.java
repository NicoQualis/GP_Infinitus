...
import Pasos.GlobalBatch_ADQ_700.TC_71_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_71_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_71_GB_PASOS_ADQ_700 pasos = new TC_71_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_71_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		//tercera validación
		queryVerif ="select fecha_cierre_liquidacion, nro_liquidacion "
				+ "from comercios_liq_cabecera \r\n"
				+ "where id_comercio_central = '8228' and fecha_cierre_liquidacion = '04/08/2022' order by nro_liquidacion desc";
	...
	private void terceraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del FECHA_CIERRE_LIQUIDACION   - Tiene que ser igual a 04/08/2022 00:00:00
		if (!respVerifBDD[0].equals("2022-08-04 00:00:00")) {
			report.AddLineAssertionError("Resultado no esperado de la validacion 3. El campo FECHA_CIERRE_LIQUIDACION  tiene el registro :" + respVerifBDD[0].toString() + " Se esperaba: 2022-08-04 00:00:00");
			System.out.println("Resultado no esperado de la validacion 3. El campo FECHA_CIERRE_LIQUIDACION  tiene el registro :" + respVerifBDD[0].toString() + " Se esperaba: 2022-08-04 00:00:00 \r\n");
			Status[2] = "FAIL - Validación del FECHA_CIERRE_LIQUIDACION ";
		}	else {
			report.AddLine("Resultado correcto de la validacion 3. El campo FECHA_CIERRE_LIQUIDACION  tiene el registro: " + respVerifBDD[0].toString());
			System.out.println("Resultado Correcto correcto de la validacion 3. El campo FECHA_CIERRE_LIQUIDACION  tiene el registro: " + respVerifBDD[0].toString() + "\r\n");
			Status[2] = "P";
		}
	...
	private boolean execPreCondiciones(Reports report, dbWorker oraWorker) {
		...
		//DELETES
		//Acción 08-
		queryPre = "delete cierres_comercios_procesados where fecha_cierre = '04/08/2022'";
