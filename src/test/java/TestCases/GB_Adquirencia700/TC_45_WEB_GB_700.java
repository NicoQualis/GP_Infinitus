...
import Pasos.GlobalBatch_ADQ_700.TC_45_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_45_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_45_GB_PASOS_ADQ_700 pasos = new TC_45_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_45_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		queryVerif ="select cc.nro_cuota, cc.fecha_pago_comercio "
				...
				+ "where a.id_autorizacion_adquirente in ('348411') and cc.nro_cuota = '1'";
		...
		queryVerif ="select cc.nro_cuota, cc.fecha_pago_comercio "
				...
				+ "inner join autorizacion a on c.id_autorizacion = a.id_autorizacion "
				+ "inner join autorizacion_adquirente_log aal on a.id_autorizacion_adquirente = aal.id_autorizacion_adquirente "
				+ "where a.id_autorizacion_adquirente in ('348411') and cc.nro_cuota = '2'";
		...
		queryVerif ="select cc.nro_cuota, cc.fecha_pago_comercio "
				...
				+ "inner join autorizacion a on c.id_autorizacion = a.id_autorizacion "
				+ "inner join autorizacion_adquirente_log aal on a.id_autorizacion_adquirente = aal.id_autorizacion_adquirente "
				+ "where a.id_autorizacion_adquirente in ('348411') and cc.nro_cuota = '3'";
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación de FECHA_PAGO_COMERCIO - Tiene que ser igual a 2022-07-28 00:00:00
		if (!respVerifBDD[1].equals("2022-07-28 00:00:00")) {
			report.AddLineAssertionError("El campo FECHA_PAGO_COMERCIO tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 2022-07-28 00:00:00");
			System.out.println("El campo FECHA_PAGO_COMERCIO tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 2022-07-28 00:00:00\r\n");
	...
	private void segundaValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación de FECHA_PAGO_COMERCIO - Tiene que ser igual a 2022-08-25 00:00:00
		if (!respVerifBDD[1].equals("2022-08-25 00:00:00")) {
			report.AddLineAssertionError("El campo FECHA_PAGO_COMERCIO tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 2022-08-25 00:00:00");
			System.out.println("El campo FECHA_PAGO_COMERCIO tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 2022-08-25 00:00:00\r\n");
	...
	private void terceraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación de FECHA_PAGO_COMERCIO - Tiene que ser igual a 2022-09-22 00:00:00
		if (!respVerifBDD[1].equals("2022-09-22 00:00:00")) {
			report.AddLineAssertionError("El campo FECHA_PAGO_COMERCIO tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 2022-09-22 00:00:00");
			System.out.println("El campo FECHA_PAGO_COMERCIO tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 2022-09-22 00:00:00\r\n");
