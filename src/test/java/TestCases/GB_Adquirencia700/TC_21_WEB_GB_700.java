...
import Pasos.GlobalBatch_ADQ_700.TC_21_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_21_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_21_GB_PASOS_ADQ_700 pasos = new TC_21_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_21_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta.equals("2022-06-27 00:00:00")) {
			...
			report.AddLineAssertionError("El campo FECHA_CIERRE_COMERCIO tiene fecha de cierre de comercio: "+rta+", se esperaba el registro 2022-06-27 00:00:00");
			System.out.println("El campo FECHA_CIERRE_COMERCIO tiene fecha de cierre de comercio: "+rta+", se esperaba el registro 2022-06-27 00:00:00 \r\n");
	...
	private boolean execPreCondiciones(Reports report, dbWorker oraWorker) {
		...
		//--INSERT--
		//Accion 04  -
		queryPre = "Insert into FERIADOS (ID_PAIS,FECHA_FERIADO,DESCRIPCION,ID_ESTADO_TIPO,ID_ESTADO,ID_AUDITORIA,ROW_VERSION,ROW_FECHA,ID_ESTADO_TIPO_CONFIRM,ID_ESTADO_CONFIRM) values ('032',to_date('24/06/2022 00:00:00','DD/MM/RRRR HH24:MI:SS'),'AUTOMATION FERIADO','6','0','1','1',to_date('08/10/2020 19:11:39','DD/MM/RRRR HH24:MI:SS'),'40','1')";
