...
import Pasos.GlobalBatch_ADQ_700.TC_82_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_82_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		TC_82_GB_PASOS_ADQ_700 pasos = new TC_82_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_82_GB_PASOS_ADQ_700 pasos) {
		// Variables
		boolean result = true;
	...
	private boolean execPreCondiciones(Reports report, dbWorker oraWorker) {
		...
		//--INSERT--//
		//Accion 01 - AUTORIZACION_ADQUIRENTE_LOG
		...
		//Accion 06 - CONSUMOS_DATOS_ADICIONALES			
