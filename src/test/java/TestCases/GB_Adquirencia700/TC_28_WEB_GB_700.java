...
import Pasos.GlobalBatch_ADQ_700.TC_28_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_28_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		TC_28_GB_PASOS_ADQ_700 pasos = new TC_28_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_28_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta.equals("-9000")) {
			...
			report.AddLineAssertionError("El campo importe_arancel tiene el registro: " + rta + ", Se esperaba el registro -9000");
			System.out.println("El campo importe_arancel tiene el registro: " + rta + ", Se esperaba el registro -9000");
		...
		if (rta.equals("30")) {
			...
			report.AddLineAssertionError("El campo arancel tiene el registro: "+rta+", se esperaba el registro 30");
			System.out.println("El campo arancel tiene el registro: "+rta+", se esperaba el registro 30");
