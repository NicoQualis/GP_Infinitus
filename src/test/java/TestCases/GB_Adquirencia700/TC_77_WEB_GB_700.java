...
import Pasos.GlobalBatch_ADQ_700.TC_77_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_77_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_77_GB_PASOS_ADQ_700 pasos = new TC_77_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_77_GB_PASOS_ADQ_700 pasos) {
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del id_consumo   - Tiene que estar vacio
		if (!(respVerifBDD.isEmpty())) {
			report.AddLineAssertionError("Resultado no esperado de la validacion 1. La tabla comercios_liq_detalles tiene el campo id_consumo con el registro registro :" + respVerifBDD.toString() + ". Se esperaba vacio");
			System.out.println("Resultado no esperado de la validacion 1. La tabla comercios_liq_detalles tiene el campo id_consumo con el registro registro :" + respVerifBDD.toString() + ". Se esperaba vacio \r\n");
