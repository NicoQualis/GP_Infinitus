...
import Pasos.GlobalBatch_ADQ_700.TC_16_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_16_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		TC_16_GB_PASOS_ADQ_700 pasos = new TC_16_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_16_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta.equals("2022-07-20 00:00:00")) {
			...
			report.AddLineAssertionError("El campo fecha_cierre_comercio tiene el registro: "+rta+", se esperaba el registro 2022-07-20 00:00:00");
			System.out.println("El campo fecha_cierre_comercio tiene el registro: "+rta+", se esperaba el registro 2022-07-20 00:00:00");
