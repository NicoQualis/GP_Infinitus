...
import Pasos.GlobalBatch_ADQ_700.TC_03_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_03_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		TC_03_GB_PASOS_ADQ_700 pasos = new TC_03_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_03_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta[0].equals("M")) {
			report.AddLine("Resultado correcto. La tabla TIPO_PRODUCTO tiene el registro: "+rta[0]);
			System.out.println("Resultado correcto. La tabla TIPO_PRODUCTO tiene el registro: "+rta[0]);
			Status[0] = "P";
		} else {
			report.AddLineAssertionError("La tabla TIPO_PRODUCTO tiene el registro: "+rta[0]+", se esperaba el registro C");
			System.out.println("La tabla TIPO_PRODUCTO tiene el registro: "+rta[0]+", se esperaba el registro C");
			Status[0] = "FAIL - TIPO_PRODUCTO";
		}
		
		//Validacion 02
		if (rta[1].equals("2022-06-24 00:00:00")) {
			report.AddLine("Resultado correcto. La tabla FECHA_PAGO_COMERCIO tiene el registro: "+rta[1]);
			System.out.println("Resultado correcto. La tabla FECHA_PAGO_COMERCIO tiene el registro: "+rta[1]);
			Status[1] = "P";
		} else {
			report.AddLineAssertionError("La tabla FECHA_PAGO_COMERCIO tiene el registro: "+rta[1]+", se esperaba el registro 2022-06-24 00:00:00");
			System.out.println("La tabla FECHA_PAGO_COMERCIO tiene el registro: "+rta[1]+", se esperaba el registro 2022-06-24 00:00:00");
