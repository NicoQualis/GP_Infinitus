...
import Pasos.GlobalBatch_ADQ_700.TC_49_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_49_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_49_GB_PASOS_ADQ_700 pasos = new TC_49_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_49_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		queryVerif ="select clc.cant_consumos, clc.importes_consumos, clc.cant_ajustes, clc.importes_ajustes \r\n"
				...
				+ "and clc.fecha_cierre = '19/07/2022' \r\n"
				+ "and clc.fecha_pago = '25/07/2022' \r\n"
	...
	private boolean execPreCondiciones(Reports report, dbWorker oraWorker) {
		...
		//DELETE
		queryPre = "delete from control_liq_comercios clc where clc.id_comercio = '8228' and clc.fecha_cierre = '19/07/2022' and clc.fecha_pago = '25/07/2022' and clc.id_moneda = '32' and clc.id_marca = '2'";
