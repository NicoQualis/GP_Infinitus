...
import Pasos.GlobalBatch_ADQ_700.TC_34_GB_PASOS_ADQ_700;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_34_WEB_GB_700 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_34_GB_PASOS_ADQ_700 pasos = new TC_34_GB_PASOS_ADQ_700();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_34_GB_PASOS_ADQ_700 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		queryVerif ="select c.id_mod_financ_comercio, c.importe_interes_com, c.porcentaje_financ, c.id_sistema_financiacion, c.tipo_porc_financ, c.importe_iva_interes_com\r\n"
				...
				+ "where a.id_autorizacion_adquirente in ('349464')";
		...
		if (rta[0].equals("15")) {
			...
			report.AddLineAssertionError("La tabla ID_MOD_FINANC_COMERCIO tiene el registro: "+rta[0]+", se esperaba el registro 15");
			System.out.println("La tabla ID_MOD_FINANC_COMERCIO  tiene el registro: "+rta[0]+", se esperaba el registro 15");
		...
		if (rta[1].equals("-1800")) {
			...
			report.AddLineAssertionError("La tabla IMPORTE_INTERES_COM tiene el registro: "+rta[1]+", se esperaba el registro -1800");
			System.out.println("La tabla IMPORTE_INTERES_COM tiene el registro: "+rta[1]+", se esperaba el registro -1800");
		...
		if (rta[2].equals("10")) {
			...
			report.AddLineAssertionError("La tabla PORCENTAJE_FINANC tiene el registro: "+rta[2]+", se esperaba el registro 10");
			System.out.println("La tabla PORCENTAJE_FINANC tiene el registro: "+rta[2]+", se esperaba el registro 10");
		...
		if (rta[5].equals("-378")) {
			...
			report.AddLineAssertionError("La tabla IMPORTE_IVA_INTERES_COM tiene el registro: "+rta[5]+", se esperaba el registro -378");
			System.out.println("La tabla IMPORTE_IVA_INTERES_COM tiene el registro: "+rta[5]+", se esperaba el registro -378");
