...
public class TC_02_AUT_API_MASTER{
	private String Status;

	// Crédito - Local - Compra Banda
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_43_Crédito_CompraLocal_Banda.txt";
			String token = "";
			String bodyData = "";
			String respBody = "";
			...
			//SET ENVIRONMENT
			AI.setEndpoint(report, repoVar, "http://10.72.0.22:8499/approval/credit");
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		queryVerf = "select count(*) from autorizacion a \r\n"
				...
				+ "where a.id_autorizacion_adquirente = '" + rrnLast6 + "' and a.modo_ingreso = '90' and a.id_marca = '1'";
