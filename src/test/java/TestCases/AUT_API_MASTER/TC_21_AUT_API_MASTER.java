...
public class TC_21_AUT_API_MASTER{
	private String Status;

	// Débito - Local - Compra Manual 
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_21_Debito_CompraLocal_Manual.txt";
			String token = "";
			String bodyData = "";
			String respBody = "";
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		queryVerf = "select count(*) from autorizacion a \r\n"
				...
				+ "where a.id_autorizacion_adquirente = '" + rrnLast6 + "' and a.modo_ingreso = '01' and a.id_marca = '1'";
