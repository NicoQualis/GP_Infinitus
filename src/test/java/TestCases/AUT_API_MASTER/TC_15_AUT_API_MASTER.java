...
public class TC_15_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_69_Crédito_ReversoLocal_Ecommerce.txt";
			String pathPre = "./API_Requests/Autorizador/MASTER/PRE_ECOMMERCE_MC.txt";
