...
public class TC_07_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_60_Crédito_AnulaciónLocal_Banda.txt";
			String pathPre = "./API_Requests/Autorizador/MASTER/PRE_BANDA_MC.txt";
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		//Tercera Validación
		queryVerf = "select  in_cod_procesamiento, id_tipo_autorizacion_adq_log, out_tipo_mensaje, id_autorizacion_original, id_auto_adq_origen from autorizacion_adquirente_log where id_autorizacion_adquirente in (select id_auto_adq_anular_reversar from autorizacion_adquirente_log where id_autorizacion_adquirente =" + rrnLast6 + ")";
