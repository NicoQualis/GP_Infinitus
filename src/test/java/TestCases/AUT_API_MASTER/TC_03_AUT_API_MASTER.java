...
public class TC_03_AUT_API_MASTER{
	private String Status;
 
	// Crédito - Local - Compra Chip
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_44_Crédito_CompraLocal_Chip.txt";
			String token = "";
			String bodyData = "";
			String respBody = "";
...
//			token = AI.getToken(report, apiResp);
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		queryVerf = "select count(*) from autorizacion a \r\n"
				...
				+ "where a.id_autorizacion_adquirente = '" + rrnLast6 + "' and a.modo_ingreso = '05' and a.id_marca = '1'";
