...
public class TC_27_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_27_Debito_AnulaciónLocal_Banda.txt";
			String pathPre = "./API_Requests/Autorizador/MASTER/PRE_BANDA_DEBITO_MC.TXT";
