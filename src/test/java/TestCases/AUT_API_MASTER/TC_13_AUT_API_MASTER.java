...
public class TC_13_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_67_Crédito_ReversoLocal_Chip.txt";
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		queryVerf = "select anular_reversar, id_auto_adq_anular_reversar,"
				+ "from autorizacion_adquirente_log where id_autorizacion_adquirente = " + rrnLast6;
