...
public class TC_26_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_26_Debito_AnulaciónLocal_Manual.txt";
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		//Primera Validación --autorización
		...
		//Segunda Validación -- autorizacion_adquirente_log
		...
		//Tercera Validación -- autorizacion_adquirente_log
		...
		//Cuarta Validación --Respuesta_mc_log
