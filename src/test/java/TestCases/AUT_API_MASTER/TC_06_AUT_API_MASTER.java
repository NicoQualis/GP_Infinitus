...
public class TC_06_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_59_Crédito_AnulaciónLocal_Manual.txt";
			String pathPre = "./API_Requests/Autorizador/MASTER/PRE_MANUAL_MC.txt";
