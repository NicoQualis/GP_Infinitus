...
public class TC_24_AUT_API_MASTER{
	private String Status;

	// Débito - Local - Compra Contactless
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_24_Debito_CompraLocal_Contactless.txt";
			String token = "";
			String bodyData = "";
			String respBody = "";
...
//			token = AI.getToken(report, apiResp);
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String rrnLast6) throws SQLException {
		...
		queryVerf = "select count(*) from autorizacion a \r\n"
				...
				+ "where a.id_autorizacion_adquirente = '" + rrnLast6 + "' and a.modo_ingreso = '07' and a.id_marca = '1'";
