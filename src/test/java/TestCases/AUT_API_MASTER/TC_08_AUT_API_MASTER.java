...
public class TC_08_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_61_Crédito_AnulaciónLocal_Chip.txt";
			String pathPre = "./API_Requests/Autorizador/MASTER/PRE_CHIP_MC.txt";
			...
			AI.setEndpoint(report, repoVar, "http://10.72.0.22:8499/Void");
