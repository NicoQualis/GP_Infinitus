...
public class TC_22_AUT_API_MASTER{
	private String Status;

	// Débito - Local - Compra Banda
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_22_Debito_CompraLocal_Banda.txt";
			String token = "";
			String bodyData = "";
			String respBody = "";
			...
			//SET ENVIRONMENT
			AI.setEndpoint(report, repoVar, "http://10.72.0.22:8499/approval/debit");
