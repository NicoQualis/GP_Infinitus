...
public class TC_09_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_62_Crédito_AnulaciónLocal_Contactless.txt";
			String pathPre = "./API_Requests/Autorizador/MASTER/PRE_CONTACTLESS_MC.TXT";
