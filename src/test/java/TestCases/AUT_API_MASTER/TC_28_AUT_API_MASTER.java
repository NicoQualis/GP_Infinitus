...
public class TC_28_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_28_Debito_AnulaciónLocal_Chip.txt";
			String pathPre = "./API_Requests/Autorizador/MASTER/PRE_CHIP_DEBITO_MC.TXT";
