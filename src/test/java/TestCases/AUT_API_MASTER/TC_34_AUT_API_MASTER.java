...
public class TC_34_AUT_API_MASTER{
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {	
			...
			String path = "./API_Requests/Autorizador/MASTER/TC_34_Debito_ReversoLocal_Contactless.txt";
			String pathPre = "./API_Requests/Autorizador/MASTER/PRE_CONTACTLESS_DEBITO_MC.txt";
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[3].equals("335822")) {
			report.AddLineAssertionError("ID_AUTORIZACION_ORIGINAL: " + respVerifBDD[3] + ". Se esperaba: 335822");
			System.out.println("ID_AUTORIZACION_ORIGINAL: " + respVerifBDD[3] + ". Se esperaba: 335822 \r\n");
