...
import Pasos.GlobalBatch_ADQ_701.TC_71_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_71_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		TC_71_GB_PASOS_ADQ_701 pasos = new TC_71_GB_PASOS_ADQ_701();
		...
		try {
			...
			gralBatch.buscarSeleccionar(report, repo, "Liquidación Comercios", "701-Scanntech Uruguay Hosting SA");
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_71_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		//tercera validación
		queryVerif ="select fecha_cierre_liquidacion, nro_liquidacion from comercios_liq_cabecera \r\n"
				+ "where id_comercio_central = '8228' and fecha_cierre_liquidacion = '14/07/2022' order by nro_liquidacion desc";
...
private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
	...
	private void terceraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[0].equals("14-07-2022 00:00:00")) {
			report.AddLineAssertionError("Resultado no esperado de la validacion 3. El campo FECHA_CIERRE_LIQUIDACION  tiene el registro :" + respVerifBDD[0].toString() + " Se esperaba: 14-07-2022 00:00:00");
			System.out.println("Resultado no esperado de la validacion 3. El campo FECHA_CIERRE_LIQUIDACION  tiene el registro :" + respVerifBDD[0].toString() + " Se esperaba: 14-07-2022 00:00:00 \r\n");
	...
	private void cuartaValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD.equals("15728")) {
			report.AddLineAssertionError("Resultado no esperado de la validacion 4. El campo ID_CONSUMO  tiene el registro :" + respVerifBDD.toString() + " Se esperaba: 15728 ");
			System.out.println("Resultado no esperado de la validacion 4. El campo ID_CONSUMO  tiene el registro :" + respVerifBDD.toString() + " Se esperaba: 15728 ");
	...
	private boolean execPreCondiciones(Reports report, dbWorker oraWorker) {
		...
		//DELETES
		//Acción 08-
		queryPre = "DELETE FROM CIERRES_COMERCIOS_PROCESADOS WHERE FECHA_CIERRE ='14/07/2022'";
