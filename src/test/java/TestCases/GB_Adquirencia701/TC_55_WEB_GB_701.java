...
import Pasos.GlobalBatch_ADQ_701.TC_55_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_55_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_55_GB_PASOS_ADQ_701 pasos = new TC_55_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_55_GB_PASOS_ADQ_701 pasos) {
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del IMPORTE_TOTAL  - Tiene que ser igual a 1
		if (!respVerifBDD.equals("1")) {
			report.AddLineAssertionError("El campo COUNT(*) tiene: " + respVerifBDD.toString() + " registros. Se esperaba: 1");
			System.out.println("El campo COUNT(*)  tiene: " + respVerifBDD.toString() + " registros. Se esperaba: 1\r\n");
