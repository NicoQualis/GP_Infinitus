...
import Pasos.GlobalBatch_ADQ_701.TC_35_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_35_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_35_GB_PASOS_ADQ_701 pasos = new TC_35_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_35_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		queryVerif ="select c.id_mod_financ_comercio, c.importe_interes_com, c.porcentaje_financ, c.id_sistema_financiacion, c.tipo_porc_financ, c.importe_iva_interes_com\r\n"
				...
				+ "where a.id_autorizacion_adquirente in ('021415')";
		...
		if (rta[0].equals("13")) {
			...
			report.AddLineAssertionError("La tabla ID_MOD_FINANC_COMERCIO tiene el registro: "+rta[0]+", se esperaba el registro 13");
			System.out.println("La tabla ID_MOD_FINANC_COMERCIO  tiene el registro: "+rta[0]+", se esperaba el registro 13");
		...
		if (rta[1].equals("400")) {
			...
			report.AddLineAssertionError("La tabla IMPORTE_INTERES_COM tiene el registro: "+rta[1]+", se esperaba el registro 400");
			System.out.println("La tabla IMPORTE_INTERES_COM tiene el registro: "+rta[1]+", se esperaba el registro 400");
		...
		if (rta[3].equals("3")) {
			...
			report.AddLineAssertionError("La tabla ID_SISTEMA_FINANCIACION tiene el registro: "+rta[3]+", se esperaba el registro 3");
			System.out.println("La tabla ID_SISTEMA_FINANCIACION tiene el registro: "+rta[3]+", se esperaba el registro 3");
		...
		if (rta[5].equals("88")) {
			...
			report.AddLineAssertionError("La tabla IMPORTE_IVA_INTERES_COM tiene el registro: "+rta[5]+", se esperaba el registro 88");
			System.out.println("La tabla IMPORTE_IVA_INTERES_COM tiene el registro: "+rta[5]+", se esperaba el registro 88");
