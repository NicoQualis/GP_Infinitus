...
import Pasos.GlobalBatch_ADQ_701.TC_21_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_21_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_21_GB_PASOS_ADQ_701 pasos = new TC_21_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_21_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta.equals("2022-06-02 00:00:00")) {
			report.AddLine("Resultado Correcto. El campo FECHA_CIERRE_COMERCIO tiene fecha de cierre de comercio " + rta);
			System.out.println("Resultado Correcto. El campo FECHA_CIERRE_COMERCIO tiene fecha de cierre de comercio "  + rta+"\r\n");
			Status[0] = "P";

		} else {
			report.AddLineAssertionError("El campo FECHA_CIERRE_COMERCIO tiene fecha de cierre de comercio: "+rta+", se esperaba el registro 2022-06-02 00:00:00");
			System.out.println("El campo FECHA_CIERRE_COMERCIO tiene fecha de cierre de comercio: "+rta+", se esperaba el registro 2022-06-02 00:00:00 \r\n");
