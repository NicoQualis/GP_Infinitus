...
import Pasos.GlobalBatch_ADQ_701.TC_32_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_32_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_32_GB_PASOS_ADQ_701 pasos = new TC_32_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_32_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta[1].equals("0")) { 
			...
			report.AddLineAssertionError("El campo IMPORTE_INTERES_COM tiene el registro: "+rta[1]+", se esperaba el registro 0");
			System.out.println("El campo IMPORTE_INTERES_COM tiene el registro: "+rta[1]+", se esperaba el registro 0");
		...
		if (rta[2]==null) { 
			...
			report.AddLineAssertionError("El campo PORCENTAJE_FINANC tiene el registro: "+rta[2]+", se esperaba el registro 0");
			System.out.println("El campo PORCENTAJE_FINANC tiene el registro: "+rta[2]+", se esperaba el registro 0");
		...
		if (rta[3]==null) { 
			...
			report.AddLineAssertionError("El campo ID_SISTEMA_FINANCIACION tiene el registro: "+rta[3]+", se esperaba el registro null");
			System.out.println("el campo ID_SISTEMA_FINANCIACION  tiene el registro: "+rta[3]+", se esperaba el registro null");
		...
		if (rta[4]==null) { 
			...
			report.AddLineAssertionError("El campo TIPO_PORC_FINANC tiene el registro: "+rta[4]+", se esperaba el registro null");
			System.out.println("El campo TIPO_PORC_FINANC   tiene el registro: "+rta[4]+", se esperaba el registro null");
		...
		if (rta[5].equals("0")) { 
			...
			report.AddLineAssertionError("El campo IMPORTE_IVA_INTERES_COM tiene el registro: "+rta[5]+", se esperaba el registro 0");
			System.out.println("El campo IMPORTE_IVA_INTERES_COM tiene el registro: "+rta[5]+", se esperaba el registro 0");
