...
import Pasos.GlobalBatch_ADQ_701.TC_37_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_37_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_37_GB_PASOS_ADQ_701 pasos = new TC_37_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_37_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		queryVerif = "	select c.id_mod_financ_comercio, c.importe_interes_com, c.porcentaje_financ, c.id_sistema_financiacion, c.tipo_porc_financ, c.importe_iva_interes_com \r\n"
				...
				+ "where a.id_autorizacion_adquirente = '21595'";
		...
		if (rta[1].equals("-3600")) { 
			...
			report.AddLineAssertionError("El campo IMPORTE_INTERES_COM tiene el registro: "+rta[1]+", se esperaba el registro -3600");
			System.out.println("El campo IMPORTE_INTERES_COM tiene el registro: "+rta[1]+", se esperaba el registro -3600 \r\n");
		...
		if (rta[3].equals("7")) { 
			...
			report.AddLineAssertionError("El campo ID_SISTEMA_FINANCIACION tiene el registro: "+rta[3]+", se esperaba el registro 7");
			System.out.println("el campo ID_SISTEMA_FINANCIACION  tiene el registro: "+rta[3]+", se esperaba el registro 7 \r\n");
		...
		if (rta[5].equals("-792")) { 
			...
			report.AddLineAssertionError("El campo IMPORTE_IVA_INTERES_COM tiene el registro: "+rta[5]+", se esperaba el registro -792");
			System.out.println("El campo IMPORTE_IVA_INTERES_COM tiene el registro: "+rta[5]+", se esperaba el registro -792 \r\n");
