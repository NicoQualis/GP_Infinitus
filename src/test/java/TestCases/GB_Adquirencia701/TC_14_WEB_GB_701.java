...
import Pasos.GlobalBatch_ADQ_701.TC_14_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_14_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_14_GB_PASOS_ADQ_701 pasos = new TC_14_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_14_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta.equals("2022-05-30 00:00:00")) {
			...
			report.AddLineAssertionError("El campo FECHA_PAGO_COMERCIO tiene el registro: "+rta+", se esperaba el registro 2022-05-30 00:00:00");
			System.out.println("El campo FECHA_PAGO_COMERCIO tiene el registro: "+rta+", se esperaba el registro 2022-05-30 00:00:00 \r\n");
			Status[0] = "FAIL - FECHA_PAGO_COMERCIO";
		}
