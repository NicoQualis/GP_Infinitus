...
import Pasos.GlobalBatch_ADQ_701.TC_28_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_28_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		TC_28_GB_PASOS_ADQ_701 pasos = new TC_28_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_28_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta.equals("-9000")) {
			report.AddLine("Resultado Correcto. La tabla CONSUMOS tiene el registro: " + rta+".");
			System.out.println("Resultado Correcto. La tabla CONSUMOS tiene el registro:" + rta+".");
			Status[0] = "P";
		} else {
			report.AddLineAssertionError("La tabla CONSUMOS tiene el registro:" + rta + ", Se esperaba el registro -9000");
			System.out.println("La tabla CONSUMOS tiene el registro:" + rta + ", Se esperaba el registro -90000");
		...
		if (rta.equals("30")) {
			...
			report.AddLineAssertionError("La tabla CONSUMOS tiene el registro: "+rta+", se esperaba el registro 30");
			System.out.println("La tabla CONSUMOS tiene el registro: "+rta+", se esperaba el registro 30");
