...
import Pasos.GlobalBatch_ADQ_701.TC_02_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_02_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		TC_02_GB_PASOS_ADQ_701 pasos = new TC_02_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_02_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		if (rta.isEmpty()==false) {
			...
			report.AddLineAssertionError("La tabla FECHA_RELACION tiene el registro: "+rta+", se esperaba el registro NOT NULL.");
			System.out.println("La tabla FECHA_RELACION tiene el registro: "+rta+", se esperaba el registro NOT NULL.");
		...
		if (rta.equals("1")) {
			...
			System.out.println("Resultado correcto. La tabla PRESENTACION_PROCESADA tiene el registro: "+rta+".");
			Status[1] = "P";
		} else {
			report.AddLineAssertionError("El campo presentacion_procesada tiene el registro: "+rta+", se esperaba el registro 1.");
			System.out.println("El campo presentacion_procesada tiene el registro: "+rta+", se esperaba el registro 1.");
