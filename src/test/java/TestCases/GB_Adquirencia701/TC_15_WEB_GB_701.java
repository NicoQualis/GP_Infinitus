...
import Pasos.GlobalBatch_ADQ_701.TC_15_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_15_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_15_GB_PASOS_ADQ_701 pasos = new TC_15_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_15_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		//Validacion 01
		if (rta.equals("2022-06-01 00:00:00")) {
			report.AddLine("Resultado correcto. La tabla FECHA_PAGO_COMERCIO tiene el registro: "+rta);
			System.out.println("Resultado correcto. La tabla FECHA_PAGO_COMERCIO tiene el registro: "+rta);
			Status[0] = "P";
		} else {
			report.AddLineAssertionError("La tabla FECHA_PAGO_COMERCIO tiene el registro: "+rta+", se esperaba el registro 2022-06-01 00:00:00");
			System.out.println("La tabla FECHA_PAGO_COMERCIO tiene el registro: "+rta+", se esperaba el registro 2022-06-01 00:00:00");
