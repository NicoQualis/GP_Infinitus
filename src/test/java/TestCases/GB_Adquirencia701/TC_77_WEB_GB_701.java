...
import Pasos.GlobalBatch_ADQ_701.TC_77_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_77_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_77_GB_PASOS_ADQ_701 pasos = new TC_77_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_77_GB_PASOS_ADQ_701 pasos) {
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD.isEmpty()) {
			report.AddLineAssertionError("Resultado no esperado de la validacion 1.El campo id_consumo , de la tabla comercios_liq_detalles tiene el registro :" + respVerifBDD.toString() + " Se esperaba vacio");
			System.out.println("Resultado no esperado de la validacion 1. El campo id_consumo , de la tabla comercios_liq_detalles  tiene el registro :" + respVerifBDD.toString() + " Se esperaba vacio \r\n");
			Status[0] = "FAIL - Validación del id_consumo  de la tabla comercios_liq_detalles ";
		}	else {
			report.AddLine("Resultado correcto de la validacion 1. El campo id_consumo, de la tabla comercios_liq_detalles  tiene el registro vacio ");
			System.out.println("Resultado correcto de la validacion 1. El campo id_consumo,de la tabla comercios_liq_detalles  tiene el registro vacio "); 
			Status[0] = "P";
		}
