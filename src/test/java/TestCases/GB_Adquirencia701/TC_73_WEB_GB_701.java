...
import Pasos.GlobalBatch_ADQ_701.TC_73_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_73_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_73_GB_PASOS_ADQ_701 pasos = new TC_73_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_73_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean execPreCondiciones(Reports report, dbWorker oraWorker) {
		...
		//DELETES
		//Acción 08-
		queryPre = "DELETE FROM CIERRES_COMERCIOS_PROCESADOS WHERE FECHA_CIERRE ='13/07/2022'";
