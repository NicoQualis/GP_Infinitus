...
import Pasos.GlobalBatch_ADQ_701.TC_65_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_65_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		TC_65_GB_PASOS_ADQ_701 pasos = new TC_65_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_65_GB_PASOS_ADQ_701 pasos) {
		// Variables
		boolean result = true;
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		queryVerif = "select count(*)\r\n"
				...
				+ "where a.id_autorizacion_adquirente in (349962,349963)";
		...
		if (rta.equals("2")) {
			...
			report.AddLineAssertionError("ERR - La tabla consumos tiene: "+rta+", se esperaban 2 registros");
			System.out.println("ERR - La tabla consumos tiene: "+rta+", se esperaban 2 registros");
			Status[0] = "FAIL - count(*)";
		}
