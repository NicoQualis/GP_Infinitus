...
import Pasos.GlobalBatch_ADQ_701.TC_50_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_50_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		try {
			...
			TC_50_GB_PASOS_ADQ_701 pasos = new TC_50_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_50_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		//Primer validación
		queryVerif ="select clc.cant_consumos, clc.importes_consumos, clc.cant_ajustes, clc.importes_ajustes \r\n"
				+ "from control_liq_comercios clc\r\n"
				+ "where clc.id_comercio = '8248' \r\n"
				+ "and clc.fecha_cierre = '15/08/2022' \r\n"
				+ "and clc.fecha_pago = '22/08/2022' \r\n"
				+ "and clc.id_moneda = '858'  \r\n"
				+ "and clc.id_marca = '2'";
		...
		queryVerif ="select clc.cant_consumos, clc.importes_consumos, clc.cant_ajustes, clc.importes_ajustes \r\n"
				+ "from control_liq_comercios clc\r\n"
				+ "where clc.id_comercio = '8248' \r\n"
				+ "and clc.fecha_cierre = '12/09/2022' \r\n"
				+ "and clc.fecha_pago = '19/09/2022' \r\n"
				+ "and clc.id_moneda = '858'  \r\n"
				+ "and clc.id_marca = '2'";
		...
		queryVerif ="select clc.cant_consumos, clc.importes_consumos, clc.cant_ajustes, clc.importes_ajustes \r\n"
				+ "from control_liq_comercios clc\r\n"
				+ "where clc.id_comercio = '8248' \r\n"
				+ "and clc.fecha_cierre = '10/10/2022' \r\n"
				+ "and clc.fecha_pago = '17/10/2022' \r\n"
				+ "and clc.id_moneda = '858'  \r\n"
				+ "and clc.id_marca = '2'";
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del CANT_CONSUMOS - Tiene que ser igual a 1
		if (!respVerifBDD[0].equals("1")) {
			report.AddLineAssertionError("El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0].toString() + ". Se esperaba: 1");
			System.out.println("El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0].toString() + ". Se esperaba: 1\r\n");
			Status[0] = "FAIL - Validación del CANT_CONSUMOS ";
		}	else {
			report.AddLine("Resultado Correcto. El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0].toString());
			System.out.println("Resultado Correcto. El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0] + "\r\n");
			Status[0] = "P";
		}

		//Validación de IMPORTES_CONSUMOS - Tiene que ser igual a 10000
		if (!respVerifBDD[1].equals("10000")) {
			report.AddLineAssertionError("El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 10000");
			System.out.println("El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 10000\r\n");
			Status[1] = "FAIL - Validación del IMPORTES_CONSUMOS";
		}	else {
			report.AddLine("Resultado Correcto. El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1]);
			System.out.println("Resultado Correcto. El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1] + "\r\n");
			Status[1] = "P";
		}	

		//Validación de CANT_AJUSTES - Tiene que ser igual a 0
		if (!respVerifBDD[2].equals("0")) {
			report.AddLineAssertionError("El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2] + ". Se esperaba: 0");
			System.out.println("El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2] + ". Se esperaba: 0\r\n");
			Status[2] = "FAIL - Validación del CANT_AJUSTES";
		}	else {
			report.AddLine("Resultado Correcto. El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2]);
			System.out.println("Resultado Correcto. El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2] + "\r\n");
			Status[2] = "P";
		}	

		//Validación de IMPORTES_AJUSTES  - Tiene que ser igual a 0
		if (!respVerifBDD[3].equals("0")) {
			report.AddLineAssertionError("El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3] + ". Se esperaba: 0");
			System.out.println("El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3] + ". Se esperaba: 0\r\n");
			Status[3] = "FAIL - Validación del IMPORTES_AJUSTES ";
		}	else {
			report.AddLine("Resultado Correcto. El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3]);
			System.out.println("Resultado Correcto. El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3] + "\r\n");
			Status[3] = "P";
		}	
	}
	...
	private void segundaValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[0].equals("1")) {
			report.AddLineAssertionError("El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0].toString() + ". Se esperaba: 1");
			System.out.println("El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0].toString() + ". Se esperaba: 1\r\n");
			Status[4] = "FAIL - Validación del CANT_CONSUMOS ";
		}	else {
			report.AddLine("Resultado Correcto. El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0].toString());
			System.out.println("Resultado Correcto. El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0] + "\r\n");
			Status[4] = "P";
		...
		if (!respVerifBDD[1].equals("10000")) {
			report.AddLineAssertionError("El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 10000");
			System.out.println("El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 10000\r\n");
			Status[5] = "FAIL - Validación del IMPORTES_CONSUMOS";
		}	else {
			report.AddLine("Resultado Correcto. El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1]);
			System.out.println("Resultado Correcto. El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1] + "\r\n");
			Status[5] = "P";
		...
		if (!respVerifBDD[2].equals("0")) {
			report.AddLineAssertionError("El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2] + ". Se esperaba: 0");
			System.out.println("El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2] + ". Se esperaba: 0\r\n");
			Status[6] = "FAIL - Validación del CANT_AJUSTES";
		}	else {
			report.AddLine("Resultado Correcto. El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2]);
			System.out.println("Resultado Correcto. El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2] + "\r\n");
			Status[6] = "P";
		...
		if (!respVerifBDD[3].equals("0")) {
			report.AddLineAssertionError("El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3] + ". Se esperaba: 0");
			System.out.println("El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3] + ". Se esperaba: 0\r\n");
			Status[7] = "FAIL - Validación del IMPORTES_AJUSTES ";
		}	else {
			report.AddLine("Resultado Correcto. El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3]);
			System.out.println("Resultado Correcto. El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3] + "\r\n");
			Status[7] = "P";
	...
	private void terceraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[0].equals("1")) {
			report.AddLineAssertionError("El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0].toString() + ". Se esperaba: 1");
			System.out.println("El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0].toString() + ". Se esperaba: 1\r\n");
			Status[8] = "FAIL - Validación del CANT_CONSUMOS ";
		}	else {
			report.AddLine("Resultado Correcto. El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0].toString());
			System.out.println("Resultado Correcto. El campo CANT_CONSUMOS tiene el registro: " + respVerifBDD[0] + "\r\n");
			Status[8] = "P";
		...
		if (!respVerifBDD[1].equals("10000")) {
			report.AddLineAssertionError("El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 10000");
			System.out.println("El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1] + ". Se esperaba: 10000\r\n");
			Status[9] = "FAIL - Validación del IMPORTES_CONSUMOS";
		}	else {
			report.AddLine("Resultado Correcto. El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1]);
			System.out.println("Resultado Correcto. El campo IMPORTES_CONSUMOS tiene el registro: " + respVerifBDD[1] + "\r\n");
			Status[9] = "P";
		...
		if (!respVerifBDD[2].equals("0")) {
			report.AddLineAssertionError("El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2] + ". Se esperaba: 0");
			System.out.println("El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2] + ". Se esperaba: 0\r\n");
			Status[10] = "FAIL - Validación del CANT_AJUSTES";
		}	else {
			report.AddLine("Resultado Correcto. El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2]);
			System.out.println("Resultado Correcto. El campo CANT_AJUSTES tiene el registro: " + respVerifBDD[2] + "\r\n");
			Status[10] = "P";
		...
		if (!respVerifBDD[3].equals("0")) {
			report.AddLineAssertionError("El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3] + ". Se esperaba: 0");
			System.out.println("El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3] + ". Se esperaba: 0\r\n");
			Status[11] = "FAIL - Validación del IMPORTES_AJUSTES ";
		}	else {
			report.AddLine("Resultado Correcto. El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3]);
			System.out.println("Resultado Correcto. El campo IMPORTES_AJUSTES  tiene el registro: " + respVerifBDD[3] + "\r\n");
			Status[11] = "P";
	...
	private boolean execPreCondiciones(Reports report, dbWorker oraWorker) {
		...
		//DELETE
		queryPre = "delete from control_liq_comercios clc where clc.id_comercio = '8248' and clc.fecha_cierre in('15/08/2022','12/09/2022','10/10/2022')and clc.fecha_pago in('22/08/2022','19/09/2022','17/10/2022') and clc.id_moneda = '858' and clc.id_marca = '2'";
	...
	private boolean execPostCondiciones (Reports report, dbWorker oraWorker) {
		...
		//Accion 01		
		queryPost = "delete from control_liq_comercios clc where clc.id_comercio = '8248' and clc.fecha_cierre in('15/08/2022','12/09/2022','10/10/2022')and clc.fecha_pago in('22/08/2022','19/09/2022','17/10/2022') and clc.id_moneda = '858' and clc.id_marca = '2'";
		res.add(oraWorker.oraDelete(queryPost, conn));

		//Accion 02	
		queryPost = "DELETE FROM PRESENTACIONES WHERE id_autorizacion_adquirente = '021415'";
		res.add(oraWorker.oraDelete(queryPost, conn));

		//Accion 03	
		queryPost = "DELETE FROM CONSUMOS_CUOTAS WHERE ID_CONSUMO in (select id_consumo from consumos where id_autorizacion in (select id_autorizacion from autorizacion where id_autorizacion_adquirente = '021415'))";
		res.add(oraWorker.oraDelete(queryPost, conn));

		//Accion 04	
		queryPost = "DELETE FROM CONSUMOS_DATOS_ADICIONALES WHERE ID_CONSUMO in (select id_consumo from consumos where id_autorizacion in (select id_autorizacion from autorizacion where id_autorizacion_adquirente = '021415'))";
		res.add(oraWorker.oraDelete(queryPost, conn));

		//Accion 05	
		queryPost = "DELETE FROM CONSUMOS WHERE ID_CONSUMO in (select id_consumo from consumos where id_autorizacion in (select id_autorizacion from autorizacion where id_autorizacion_adquirente = '021415'))";
		res.add(oraWorker.oraDelete(queryPost, conn));

		//Accion 06	
		queryPost = "DELETE FROM AUTORIZACION WHERE ID_AUTORIZACION_ADQUIRENTE = '021415'";
		res.add(oraWorker.oraDelete(queryPost, conn));

		//Accion 07	
		queryPost = "DELETE FROM RESPUESTA_MC_LOG WHERE ID_AUTORIZACION_ADQUIRENTE = '021415'";
		res.add(oraWorker.oraDelete(queryPost, conn));

		//Accion 08	
		queryPost = "DELETE FROM AUTORIZACION_ADQUIRENTE_LOG WHERE ID_AUTORIZACION_ADQUIRENTE = '021415'";
		res.add(oraWorker.oraDelete(queryPost, conn));
	...
	private void execPrePostCondi(Reports report, dbWorker oraWorker) {
		...
		oraWorker.oraDelete("delete from control_liq_comercios clc where clc.id_comercio = '8248' and clc.fecha_cierre in('15/08/2022','12/09/2022','10/10/2022')and clc.fecha_pago in('22/08/2022','19/09/2022','17/10/2022') and clc.id_moneda = '858' and clc.id_marca = '2'", conn);
		oraWorker.oraDelete("DELETE FROM PRESENTACIONES WHERE id_autorizacion_adquirente = '021415'", conn);
		oraWorker.oraDelete("DELETE FROM CONSUMOS_CUOTAS WHERE ID_CONSUMO in (select id_consumo from consumos where id_autorizacion in (select id_autorizacion from autorizacion where id_autorizacion_adquirente = '021415'))", conn);
		oraWorker.oraDelete("DELETE FROM CONSUMOS_DATOS_ADICIONALES WHERE ID_CONSUMO in (select id_consumo from consumos where id_autorizacion in (select id_autorizacion from autorizacion where id_autorizacion_adquirente = '021415'))", conn);
		oraWorker.oraDelete("DELETE FROM CONSUMOS WHERE ID_CONSUMO in (select id_consumo from consumos where id_autorizacion in (select id_autorizacion from autorizacion where id_autorizacion_adquirente = '021415'))", conn);
		oraWorker.oraDelete("DELETE FROM AUTORIZACION WHERE ID_AUTORIZACION_ADQUIRENTE = '021415'", conn);
		oraWorker.oraDelete("DELETE FROM RESPUESTA_MC_LOG WHERE ID_AUTORIZACION_ADQUIRENTE = '021415'", conn);
		oraWorker.oraDelete("DELETE FROM AUTORIZACION_ADQUIRENTE_LOG WHERE ID_AUTORIZACION_ADQUIRENTE = '021415'", conn);
