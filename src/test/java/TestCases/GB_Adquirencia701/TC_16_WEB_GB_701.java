...
import Pasos.GlobalBatch_ADQ_701.TC_16_GB_PASOS_ADQ_701;
import Repositories.Repo_WebRepository;
import Tools.dbWorker;
import io.restassured.path.json.JsonPath;

public class TC_16_WEB_GB_701 {
	...
	public boolean Test(Datasources data, Reports report, DriverManager DM, int iteration, String name, String configEntidad) {
		...
		TC_16_GB_PASOS_ADQ_701 pasos = new TC_16_GB_PASOS_ADQ_701();
	...
	private boolean validacionesWeb(Reports report, Repo_WebRepository repo, DriverManager DM, String name, String runId, TC_16_GB_PASOS_ADQ_701 pasos) {
	...
	private boolean validacionesBD (dbWorker oraWorker, Reports report) throws SQLException {
		...
		//Validacion 01
		if (rta.equals("2022-07-15 00:00:00")) {
			...
			report.AddLineAssertionError("El campo fecha_cierre_comercio tiene el registro: " +rta+ ", se esperaba el registro 2022-07-15 00:00:00");
			System.out.println("El campo fecha_cierre_comercio tiene el registro: "+rta+", se esperaba el registro 2022-07-15 00:00:00");
