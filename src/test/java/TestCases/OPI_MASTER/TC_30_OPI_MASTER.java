...
public class TC_30_OPI_MASTER {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_ECOMMERCE_MC.xml", "MASTER/TC_30_MC.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_30_MC.xml");
