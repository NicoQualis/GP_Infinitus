...
public class TC_31_OPI_MASTER {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_MANUAL_MC.xml", "MASTER/TC_31_MC.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_31_MC.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_31_MC.xml", configEntidad, "opi4qa");
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[2].equals("9")) {
			report.AddLine("ID_TIPO_AUTORIZACION_ADQ_LOG: " + respVerifBDD[2] + ". Se esperaba: 0");
			System.out.println("ID_TIPO_AUTORIZACION_ADQ_LOG: " + respVerifBDD[2] + ". Se esperaba: 0\r\n");
