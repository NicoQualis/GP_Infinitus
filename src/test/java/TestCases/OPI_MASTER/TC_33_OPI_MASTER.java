...
public class TC_33_OPI_MASTER {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_CHIP_MC.xml", "MASTER/TC_33_MC.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_33_MC.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_33_MC.xml", configEntidad, "opi4qa");
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String f37Last6) throws SQLException {
		...
		//Primera Validación
		queryVerf = "elect id_autorizacion, id_autorizacion_adquirente, id_estado, modo_ingreso\r\n"
