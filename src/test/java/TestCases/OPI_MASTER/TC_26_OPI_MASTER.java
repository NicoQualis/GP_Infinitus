...
public class TC_26_OPI_MASTER {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_MANUAL_MC.xml", "MASTER/TC_26_MC.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_26_MC.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_26_MC.xml", configEntidad, "opi4qa");
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[1].equals("01")) {
			report.AddLine("MODO_INGRESO: " + respVerifBDD[1] + ". Se esperaba: 01");
