...
public class TC_28_OPI_MASTER {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_CHIP_MC.xml", "MASTER/TC_28_MC.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_28_MC.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_28_MC.xml", configEntidad, "opi4qa");
