...
public class TC_35_OPI_MASTER {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_ECOMMERCE_MC.xml", "MASTER/TC_35_MC.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_35_MC.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_35_MC.xml", configEntidad, "opi4qa");
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[5].equals(id_AutoAdq)) {
			...
			System.out.println("ID_AUTO_ADQ_ORIGEN: " + respVerifBDD[5] + ". Se esperaba: " + id_Auto + "\r\n");
