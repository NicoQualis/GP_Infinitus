...
public class TC_20_OPI_MASTER {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_ECOMMERCE_MC.xml", "MASTER/TC_20_MC.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_20_MC.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_20_MC.xml", configEntidad, "opi4qa");
