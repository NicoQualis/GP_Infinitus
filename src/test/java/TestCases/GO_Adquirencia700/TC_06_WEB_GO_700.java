...
public class TC_06_WEB_GO_700 {
	...
	public boolean Test(Datasources data,Reports report, DriverManager DM, int iteration,String name, String configEntidad) {
		...
		try {		
			...
			menu.navegacion_lvl4(data, report, DM, iteration, name, repo, "Adquirencia", "Comercios", "Parametría", "Modelos de Transacción");
			...
			if(rtaBorrar > 0) {
				...
				report.AddLineAssertionError("Error al eliminar el modelos_transaccion; realizar su eliminación manual");
				System.out.println("Error al eliminar el modelos_transaccion; realizar su eliminación manual\r\n");
				result = false;
			}
