...
public class TC_30_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_ECOMMERCE_VISA_DEBITO.xml", "VISA/TC_30_VISA.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_30_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_30_VISA.xml", configEntidad, "opi4qa");
	...
	private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		if (!respVerifBDD[3].equals("81")) {
			report.AddLineAssertionError("MODO_INGRESO: " + respVerifBDD[3] + ". Se esperaba: 81");
			System.out.println("MODO_INGRESO: " + respVerifBDD[3] + ". Se esperaba: 81\r\n");
