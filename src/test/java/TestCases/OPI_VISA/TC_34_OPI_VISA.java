...
public class TC_34_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_CONTACTLESS_VISA_DEBITO.xml", "VISA/TC_34_VISA.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_34_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_34_VISA.xml", configEntidad, "opi4qa");
			...
			report.AddLineAssertionError("Error:<br>" + e);
	...
	private void tercerValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
		...
		//Validación del ID_AUTORIZACION_ORIGINAL - Tiene que ser: '336491'
		if (!respVerifBDD[4].equals("336491")) {
			report.AddLineAssertionError("ID_AUTORIZACION_ORIGINAL: " + respVerifBDD[4] + ". Se esperaba: 336491");
			System.out.println("ID_AUTORIZACION_ORIGINAL: " + respVerifBDD[4] + ". Se esperaba: 336491\r\n");
		...
		//Validación del ID_AUTO_ADQ_ORIGEN - Tiene que ser: '340489'
		if (!respVerifBDD[5].equals("340489")) {
			report.AddLineAssertionError("ID_AUTO_ADQ_ORIGEN: " + respVerifBDD[5] + ". Se esperaba: 340489");
			System.out.println("ID_AUTO_ADQ_ORIGEN: " + respVerifBDD[5] + ". Se esperaba: 340489\r\n");
