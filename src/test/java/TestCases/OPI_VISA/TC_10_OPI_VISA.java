...
public class TC_10_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
            ...
            String xmlFile = Files.readString(Paths.get("./OPI_Files/VISA/PRE_ECOMMERCE_VISA.xml"));
            //Enviar a OPI el archivo generado
            opiCmd.sshSendCmdCreateXml(report, xmlFile, configEntidad, "opi4qa", "PRE_ECOMMERCE_VISA.xml");
            
            //Creación del XML a subir
            xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_ECOMMERCE_VISA.xml", "VISA/TC_10_VISA.xml");
            
           //Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_10_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_10_VISA.xml", configEntidad, "opi4qa");
