	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			if (!opiCmd.getOpiStatus(configEntidad))
			 ...
			 String xmlFile = Files.readString(Paths.get("./OPI_Files/VISA/PRE_CHIP_VISA.xml"));
            //Enviar a OPI el archivo generado
            opiCmd.sshSendCmdCreateXml(report, xmlFile, configEntidad, "opi4qa", "PRE_CHIP_VISA.xml");
            
            //Creación del XML a subir
            xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_CHIP_VISA.xml", "VISA/TC_08_VISA.xml");
            
           //Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_08_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_08_VISA.xml", configEntidad, "opi4qa");
