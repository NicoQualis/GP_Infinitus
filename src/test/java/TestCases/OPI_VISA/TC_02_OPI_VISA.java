...
public class TC_02_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			String xmlFile = Files.readString(Paths.get("./OPI_Files/VISA/TC_02_VISA.xml"));
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFile, configEntidad, "opi4qa", "TC_02_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_02_VISA.xml", configEntidad, "opi4qa");
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String f37Last6) throws SQLException {
		...
		queryVerf = "select count(*) from autorizacion a\r\n"
				...
				+ "where a.id_autorizacion_adquirente = '" + f37Last6 + "' and a.id_marca = '2' and a.modo_ingreso = '90' and id_estado = '0'";
