...
public class TC_15_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
            ...
            xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_ECOMMERCE_VISA.xml", "VISA/TC_15_VISA.xml");
            
           //Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_15_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_15_VISA.xml", configEntidad, "opi4qa");
