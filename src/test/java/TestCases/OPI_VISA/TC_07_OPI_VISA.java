...
public class TC_07_OPI_VISA {
    ...
    public boolean Test(Reports report, String name, String configEntidad) {
        ...
        try {       
            ...
            xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_BANDA_VISA.xml", "VISA/TC_07_VISA.xml");
            
           //Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_07_VISA.xml");
            ...
            res = opiCmd.sshSendCmdGetDE37(report, "TC_07_VISA.xml", configEntidad, "opi4qa");
    ...
    private String execPreCondicion(Reports report, String configEntidad, sshWorker opiCmd, String xmlPreFile, String xmlFileRead) throws IOException, InterruptedException {
        //VARIABLES
    ...
    private boolean validacionGral(dbWorker oraResp, Reports report, String f37Last6) throws SQLException {
        ...
        //Cuarta Validación --TABLA Respuesta_mc_log
    ...
    private void primeraValidacion(dbWorker oraResp, Reports report, String query) throws SQLException {
        ...
        if (!respVerifBDD[3].equals("90")) {
            report.AddLineAssertionError("MODO_INGRESO: " + respVerifBDD[3] + ". Se esperaba: 90");
            System.out.println("MODO_INGRESO: " + respVerifBDD[3] + ". Se esperaba: 90\r\n");
