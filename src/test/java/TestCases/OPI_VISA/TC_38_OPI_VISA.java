...
public class TC_38_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_CHIP_VISA_DEBITO.xml", "VISA/TC_38_VISA.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_38_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_38_VISA.xml", configEntidad, "opi4qa");
