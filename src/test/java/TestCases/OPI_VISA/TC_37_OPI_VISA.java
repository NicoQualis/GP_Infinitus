...
public class TC_37_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_BANDA_VISA_DEBITO.xml", "VISA/TC_37_VISA.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_37_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_37_VISA.xml", configEntidad, "opi4qa");
