...
public class TC_19_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
            ...
            xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_CONTACTLESS_VISA.xml", "VISA/TC_19_VISA.xml");
            
           //Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_19_VISA.xml");		
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_19_VISA.xml", configEntidad, "opi4qa");
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String f37Last6) throws SQLException {
		...
		queryVerf = "select count(*) from autorizacion a "
				...
				+ "where a.id_autorizacion_adquirente = '" +  f37Last6 + "' and a.id_estado = 0 and a.modo_ingreso = 07";
