...
public class TC_18_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
            ...
            xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_CHIP_VISA.xml", "VISA/TC_18_VISA.xml");
            
           //Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_18_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_18_VISA.xml", configEntidad, "opi4qa");
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String f37Last6) throws SQLException {
		...
		queryVerf = "select count(*) from autorizacion a "
				...
				+ "where a.id_autorizacion_adquirente = '" +  f37Last6 + "' and a.id_estado = 0 and a.modo_ingreso = 05";
