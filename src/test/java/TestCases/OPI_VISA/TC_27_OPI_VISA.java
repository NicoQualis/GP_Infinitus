...
public class TC_27_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			xmlFileCreate = execPreCondicion(report, configEntidad, opiCmd, "PRE_BANDA_VISA_DEBITO.xml", "VISA/TC_27_VISA.xml");
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFileCreate, configEntidad, "opi4qa", "TC_27_VISA.xml");
			...
			opiCmd.cambioSimuladorVisa(report, configEntidad, "opi4qa", "700", "reversos");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_27_VISA.xml", configEntidad, "opi4qa");
			...
			opiCmd.cambioSimuladorVisa(report, configEntidad, "opi4qa", "700", "compras");
	...
	private boolean validacionGral(dbWorker oraResp, Reports report, String f37Last6) throws SQLException {
		...
		queryVerf = "select anular_reversar, id_auto_adq_anular_reversar "
				...
				+ "where id_autorizacion_adquirente =" + f37Last6;
