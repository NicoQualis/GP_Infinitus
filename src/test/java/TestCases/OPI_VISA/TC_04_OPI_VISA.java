...
public class TC_04_OPI_VISA {
	...
	public boolean Test(Reports report, String name, String configEntidad) {
		...
		try {		
			...
			String xmlFile = Files.readString(Paths.get("./OPI_Files/VISA/TC_04_VISA.xml"));
			
			//Enviar a OPI el archivo generado
			opiCmd.sshSendCmdCreateXml(report, xmlFile, configEntidad, "opi4qa", "TC_04_VISA.xml");
			...
			res = opiCmd.sshSendCmdGetDE37(report, "TC_04_VISA.xml", configEntidad, "opi4qa");
