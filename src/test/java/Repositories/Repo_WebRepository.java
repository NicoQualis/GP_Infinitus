...
public class Repo_WebRepository {
	...
	public WebElement get_obj_btnNuevo2(){		
		return driver.findElement(By.xpath("//button[@name='btnNewModeloPago']"));
		
	}
	public WebElement get_obj_btnNuevo3(){		
		return driver.findElement(By.xpath("//button[@class='btn btn-new btnNew']"));
		
	}
	public WebElement get_obj_btnNuevo4(){		
		return driver.findElement(By.xpath("//button[@name='btnNewModeloTransaccion']"));
	...
	public String[] get_def_h1Login() {
		return new String[] {"id","//div[@id='maincontent']"};
	}
	public WebElement get_obj_h1Login(){		
		return driver.findElement(By.xpath("//div[@id='maincontent']"));
	}
	
	// TITULO LOGIN GB
	public String[] get_def_TitleLogin() {
		return new String[] {"id","//div[@id='kc-header-wrapper']"};
	}
	public WebElement get_obj_TitleLogin(){		
		return driver.findElement(By.xpath("//div[@id='kc-header-wrapper']"));
	}
	...
	// INPUT UNICO X NAME 
	public WebElement get_obj_inputTextByName3(String name){		
		return driver.findElement(By.cssSelector("div.content.tab-content div.tab-container.active:nth-child(2) form.formNew:nth-child(4) div.step.current:nth-child(2) div.panel.edit-on.clearfix.col-md-12.col-lg-9:nth-child(2) div.row:nth-child(3) div.form-group.col-md-4:nth-child(3) div:nth-child(2) > input.form-control.inputResponsableDomicilioTelefono"));
	...
	// BUTTON
	// Boton Guardar
	public WebElement get_obj_btnConfirmacionLanzamiento(){		
		return driver.findElement(By.xpath("//button[@id='boton_confirmacion_lanzamiento']"));
	}
	// Boton Confirmar
	public WebElement get_obj_btnLanzamiento() {
		return driver.findElement(By.xpath("//button[@id='boton_lanzamiento']"));
	}
	...
	// TITULOS
	// Titulo Lanzar Proceso
	public String get_def_tituloLanzaProceso(String nombreProceso){		
		return "//h1[contains(text(),'" + nombreProceso + "')]";
	}
	public WebElement get_obj_tituloLanzaProceso(String nombreProceso){		
		return driver.findElement(By.xpath("//h1[contains(text(),'" + nombreProceso + "')]"));
	}
	
	//Titulo confirmacion lanzamiento 
	public String get_def_tituloConfirmacionLanzamiento(){		
		return "//h5[contains(text(),'Usted va a lanzar el proceso: ')]";
	}
	public WebElement get_obj_tituloConfirmacionLanzamiento(){		
		return driver.findElement(By.xpath("//h5[contains(text(),'Usted va a lanzar el proceso: ')]"));
	}
	
	// Título Procesos en Ejecución
	public String get_def_tituloProcesosEnEjecucion(){		
		return "//h1/a[text()='Procesos en Ejecución']";
	}
	public WebElement get_obj_tituloProcesosEnEjecucion(){		
		return driver.findElement(By.xpath("//h1/a[text()='Procesos en Ejecución']"));
	}
	...
	//Select utilizando ID sin Opcion
	public WebElement get_obj_selectById(String id){		
		return driver.findElement(By.xpath("//select[@id='" + id + "']"));
	}
	
	// TABLAS PROCESOS
	//TD Adquirencia Argentina
	public WebElement get_obj_btnLancarProceso(String nombreProceso) {
		return driver.findElement(By.xpath("//a[@data-nombre_proceso='" + nombreProceso + "']"));
	}
	//
	public WebElement get_obj_lblRunIdRunning() {
		return driver.findElement(By.xpath("//table[@id='ejecuciones']//td[@class='runID']/div[@class='contentTooltip']"));
	}
	//
	public String get_def_lblRunIdRan(String runId) {
		return "//table[@id='logs']//td[@class='runID']/div[text()='" + runId + "']";
	}
	public WebElement get_obj_lblRunIdRan(String runId) {
		return driver.findElement(By.xpath("//table[@id='logs']//td[@class='runID']/div[text()='" + runId + "']"));
	}
	//
	public WebElement get_obj_iconRunIdRan(String runId) {
		return driver.findElement(By.xpath("//table[@id='logs']//td[@class='runID']/div[text()='" + runId + "']/../..//td[@class='tdIcon']/span[@class='iconEstado']"));
	}
	//
	public WebElement get_obj_lblProcesadoRunIdRan(String runId) {
		return driver.findElement(By.xpath("//table[@id='logs']//td[@class='runID']/div[text()='" + runId + "']/../..//td[contains(.,'/') and not(contains(.,':'))]"));
	}
	...
	// Boton Proceso
	public WebElement get_obj_btnProceso() {
        return driver.findElement(By.xpath(".//li[@class='navProcesos']"));
    }
	// Boton LogOff ADQ
	public WebElement get_obj_btnLogOff() {
		return driver.findElement(By.xpath("//a[@id='logOff']"));
	}
